...
namespace CardShopCoop.Net.Messages
{
    ...
    /// <summary>Client -> host: the joiner bought restock (send the ordered product to
    /// be spawned officially). Layout mirrors CoopCore's OrderRequest writer/reader.</summary>
    [NetworkMessage(MsgType.OrderRequest, Policy = MessagePolicy.HostOnly)]
    public sealed class OrderRequestMessage : INetMessage
    {
        public EItemType ItemType;
        public bool IsBig;
        public string Name = "";
    ...
    /// <summary>Client -> host: the joiner bought furniture (deliver on the host).
    /// Layout mirrors CoopCore's FurnitureOrder writer/reader.</summary>
    [NetworkMessage(MsgType.FurnitureOrder, Policy = MessagePolicy.HostOnly)]
    public sealed class FurnitureOrderMessage : INetMessage
    {
